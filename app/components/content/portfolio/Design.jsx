...
export default function Design() {
  ...
  return (
    <ul className="portfolio-data portfolio-grid-design w-full grid gap-[15px] sm:grid-cols-2 lg:grid-cols-3">
      {/* 1 */}
      <li className='portfolio-project project-design-1 flex items-center justify-center bg-[#ccc] overflow-hidden rounded-[10px] aspect-[600/400]'>
      ...
      {/* 2 */}
      <li className='portfolio-project project-design-2 flex items-center justify-center bg-[#ccc] overflow-hidden rounded-[10px] aspect-[600/700]'>
        <Link href="#" className='relative w-full h-full flex items-center justify-center p-[30px] text-[#666]'>
          <h3 className='text-[22px] font-bold leading-none'>Design</h3>
          <div className='overlay absolute top-0 bottom-0 w-full flex items-center justify-center text-white transition-all duration-300'>
            <h4 className='text-[22px] font-bold leading-none'>Project Name</h4>
      ...
      {/* 3 */}
      <li className='portfolio-project project-design-3 flex items-center justify-center bg-[#ccc] overflow-hidden rounded-[10px] aspect-square'>
        <Link href="#" className='relative w-full h-full flex items-center justify-center p-[30px] text-[#666]'>
          <h3 className='text-[22px] font-bold leading-none'>Design</h3>
          <div className='overlay absolute top-0 bottom-0 w-full flex items-center justify-center text-white transition-all duration-300'>
            <h4 className='text-[22px] font-bold leading-none'>Project Name</h4>
